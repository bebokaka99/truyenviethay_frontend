...
import {
    ...
    RiLoader4Line // Thêm icon loading
} from 'react-icons/ri';
                        ...
                        <div className="hidden md:block relative" ref={searchRef}>
                            <div className="flex items-center bg-[#252538] rounded-full px-3 py-1.5 border border-white/5 focus-within:border-primary/50 transition-colors relative z-20">
                                ...
                                <input
                                    ...
                                    onFocus={() => keyword.length >= 2 && setShowDropdown(true)} // Hiện lại khi focus nếu đã có text
                                />
                                    ...
                                    {isSearching ? (
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <div className="border-t border-white/5 mt-2 pt-2">
                                                <button onClick={handleSearchSubmit} className="w-full text-center text-xs text-primary font-bold py-2 hover:underline">
