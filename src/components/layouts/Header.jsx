...
const Header = () => {
  ...
  // State bật tắt dropdown thông báo (để dùng cho cả click mobile và hover desktop)
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
                <div className="flex items-center gap-4">
                    ...
                    {/* --- NÚT THÔNG BÁO (HIỆN CẢ MOBILE & DESKTOP) --- */}
                    <div 
                        className="relative group" 
                        onMouseEnter={() => window.innerWidth >= 1024 && handleReadNotify()} // Desktop: Hover để đọc
                    >
                        <button 
                            onClick={() => { setShowNotifDropdown(!showNotifDropdown); handleReadNotify(); }} // Mobile: Click để mở & đọc
                        ...
                        {/* Logic CSS:
                            - Mobile (Mặc định): fixed top-16 left-2 right-2 -> Ghim cố định, full chiều ngang, nằm ngay dưới header.
                            - Desktop (lg): absolute right-0 w-80 -> Trở về dạng dropdown gọn gàng.
                            - Sử dụng group-hover:block cho Desktop hover, và state showNotifDropdown cho Mobile click.
                        */}
                        <div className={`
                    ...
                    {/* User Menu (Desktop Only - Mobile nằm trong Hamburger) */}
