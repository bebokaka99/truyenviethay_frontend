...
const ComicDetailPage = () => {
    ...
    const [loadingSuggestions, setLoadingSuggestions] = useState(true); // State loading riêng cho gợi ý
        ...
        try {
            ...
            const detailedSuggestions = await Promise.all(shuffled.map(async (item) => {
                try {
                    ...
                    console.error(`Lỗi lấy chi tiết gợi ý ${item.slug}:`, err);
    ...
    }, [slug]); // Thêm slug vào dependency để fetch lại khi đổi truyện

    // Gọi fetch gợi ý khi component mount hoặc slug thay đổi
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen w-full bg-[#101022] font-display text-gray-300 pb-20">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 md:-mt-40 relative z-10">
                ...
                {/* BODY CONTENT - BỎ GRID Ở ĐÂY, CHUYỂN VỀ FLEX COL */}
                <div className="flex flex-col gap-8 mt-8">
                    ...
                    {/* --- PHẦN GỢI Ý MỚI (Hiển thị trên mọi thiết bị) --- */}
